    ...
    try {
      ...
      if (analysis) {
        ...
        try {
          ...
          console.log('Structured analysis before insertion:', {
            structure: Object.keys(structuredAnalysis),
            styleFields: Object.keys(structuredAnalysis.style),
            compositionFields: Object.keys(structuredAnalysis.composition),
            techniqueFields: Object.keys(structuredAnalysis.technique)
          });
